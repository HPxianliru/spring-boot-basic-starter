...
@Slf4j
@Component
public class DeadConsumerHandlerServiceImpl implements ConsumerHandlerService {
    ...
    public boolean isMatch(RabbitMQEnums rabbitMQEnums) {
        ...
        return RabbitMQEnums.DEAD_QUEUE.getQueueName().equals(rabbitMQEnums.getQueueName())?Boolean.TRUE:Boolean.FALSE;
    }
